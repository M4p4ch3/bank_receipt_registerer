...
class OpMgr():
    ...
    def __init__(self, op_list_file_path: str):

        self.logger = logging.getLogger(self.__class__.__name__)

        self.op_list_file_path = op_list_file_path
        self.logger.debug("OpMgr: op_list_file_path = %s", self.op_list_file_path)
    ...
    def load(self):
        ...
        with open(self.op_list_file_path, mode="a", encoding="utf8"):
            pass

        with open(self.op_list_file_path, mode="r", encoding="utf8") as op_list_file:
    ...
    def save(self):
        ...
        with open(self.op_list_file_path, mode="w", encoding="utf8") as op_list_file:
            op_list_csv_writer = csv.DictWriter(op_list_file,
                fieldnames=Operation.CSV_KEY_LIST)
